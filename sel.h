//Library to assemble local M and local B.
...
//This should be on assembly.h, but is too extense so it is cool here, this is called on assembly.h for each element.
